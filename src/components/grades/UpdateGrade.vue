                        ...
                        <div class="needs-validation">
                            <form @submit.prevent="submit" class="needs-validation" novalidate>
                                <div class="form-group row mx-2">
                                    <label class="form-label " for="gradeName">New Name</label>
                                ...
                                <button type="submit" class="btn btn-outline-primary ">
                                    ...
                                    <span v-else> <i class="fas fa-plus mx-1"></i>Update Grade</span>
        ...
        methods: {
            ...
            async updateGrade() {
                ...
                try {
                    ...
                    let reference = await db.collection(`grades`)
                        .doc(refId)
                        .set({
                            "name": this.gradeName,
                        });
